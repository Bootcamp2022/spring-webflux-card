...
public class DebitCardController {
    ...
    private Mono<DebitCard> create(@RequestBody DebitCardRequestDto debitCardRequestDto) {
    ...
    @PutMapping
    @ResponseStatus(HttpStatus.OK)
    private Mono<DebitCard> update(@RequestBody DebitCardRequestDto debitCardRequestDto) {
        return debitCardService.update(debitCardRequestDto);
    }
